...
# use border
mylegend<-frameGrob()
mylegend<-packGrob(mylegend,textGrob("Legend 1"),row=1,col=1,height=unit(1.25,"lines"),border=unit(rep(0.25,4),"lines"))
mylegend<-packGrob(mylegend,textGrob("Legend 2"),row=2,col=1,height=unit(1.25,"lines"),border=unit(rep(0.25,4),"lines"))
mylegend<-packGrob(mylegend,textGrob("Legend 3"),row=3,col=1,height=unit(1.25,"lines"),border=unit(rep(0.25,4),"lines"))
mylegend<-packGrob(mylegend,textGrob("Legend 4"),row=4,col=1,height=unit(1.25,"lines"),border=unit(rep(0.25,4),"lines"))
mylegend<-packGrob(mylegend,textGrob("Legend 5"),row=5,col=1,height=unit(1.25,"lines"),border=unit(rep(0.25,4),"lines"))
...
# use border
mylegend<-frameGrob()
mylegend<-packGrob(mylegend,textGrob("Legend 1"),row=1,col=1,height=unit(1.25,"lines"),border=unit(rep(0.1,4),"lines"))
mylegend<-packGrob(mylegend,textGrob("Legend 2"),row=2,col=1,height=unit(1.25,"lines"),border=unit(rep(0.1,4),"lines"))
mylegend<-packGrob(mylegend,textGrob("Legend 3"),row=3,col=1,height=unit(1.25,"lines"),border=unit(rep(0.1,4),"lines"))
mylegend<-packGrob(mylegend,textGrob("Legend 4"),row=4,col=1,height=unit(1.25,"lines"),border=unit(rep(0.1,4),"lines"))
mylegend<-packGrob(mylegend,textGrob("Legend 5"),row=5,col=1,height=unit(1.25,"lines"),border=unit(rep(0.1,4),"lines"))
...
pushViewport(viewport(
  x=0,y=0,
  width=unit(1,"grobwidth",mylegend)+unit(2,"lines"),
  height=unit(1,"grobheight",mylegend)+unit(2,"lines"),
  just=c(0,0)))
grid.rect()
grid.draw(mylegend)
```
...
myborder<-unit(c(0.1,1,0.1,1),"lines")

mylegend<-frameGrob()
mylegend<-packGrob(mylegend,textGrob("Legend 1"),row=1,col=1,height=unit(1.25,"lines"),border=myborder)
mylegend<-packGrob(mylegend,textGrob("Legend 2"),row=2,col=1,height=unit(1.25,"lines"),border=myborder)
mylegend<-packGrob(mylegend,textGrob("Legend 3"),row=3,col=1,height=unit(1.25,"lines"),border=myborder)
mylegend<-packGrob(mylegend,textGrob("Legend 4"),row=4,col=1,height=unit(1.25,"lines"),border=myborder)
mylegend<-packGrob(mylegend,textGrob("Legend 5"),row=5,col=1,height=unit(1.25,"lines"),border=myborder)

mylegend<-packGrob(mylegend,pointsGrob(x=0.5,y=0.5,size=unit(5,"points")),row=1,col=2,width=unit(3,"lines"),border=myborder)
mylegend<-packGrob(mylegend,linesGrob(x=c(0,1),y=c(0.5,0.5)),row=1,col=2,width=unit(3,"lines"),border=myborder)
mylegend<-packGrob(mylegend,pointsGrob(x=0.5,y=0.5,size=unit(5,"points")),row=2,col=2,width=unit(3,"lines"),border=myborder)
mylegend<-packGrob(mylegend,linesGrob(x=c(0,1),y=c(0.5,0.5)),row=2,col=2,width=unit(3,"lines"),border=myborder)
mylegend<-packGrob(mylegend,pointsGrob(x=0.5,y=0.5,size=unit(5,"points")),row=3,col=2,width=unit(3,"lines"),border=myborder)
mylegend<-packGrob(mylegend,pointsGrob(x=0.5,y=0.5,size=unit(5,"points")),row=4,col=2,width=unit(3,"lines"),border=myborder)
mylegend<-packGrob(mylegend,pointsGrob(x=0.5,y=0.5,size=unit(5,"points")),row=5,col=2,width=unit(3,"lines"),border=myborder)
